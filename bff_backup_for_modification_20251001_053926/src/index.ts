...
import { registerChatCompat } from './routes/chat_compat';
import { registerV2 } from './routes/v2.full';
import { registerSave } from './routes/save';
import { registerPoints } from './routes/points';
